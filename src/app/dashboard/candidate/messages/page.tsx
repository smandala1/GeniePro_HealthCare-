            ...
            <div className="flex-1 overflow-y-auto divide-y divide-gray-50">
              {isLoading ? (
                ...
                <div className="flex flex-col items-center justify-center h-full py-12 px-4 text-center">
                  ...
                  <p className="text-xs text-gray-400 mt-1">Recruiters will message you here.</p>
                </div>
              ) : (
                messages.map((msg) => {
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-2.5">
                        <div className="h-8 w-8 rounded-full bg-primary-100 flex items-center justify-center shrink-0 text-xs font-bold text-primary-600">
