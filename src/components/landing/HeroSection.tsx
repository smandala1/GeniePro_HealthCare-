...
function EmployerModal({ onClose }: { onClose: () => void }) {
  return (
    <div
      ...
      >
        ...
        <div className="flex flex-col gap-4">
          <div>
            ...
            <a
              href="mailto:hiring@geniepro.com"
          ...
          <div>
            ...
            <a href="tel:+14701234567" className="font-semibold text-gray-800">
              (470) 123-4567
            </a>
          </div>
          <div>
            <p className="text-xs font-semibold text-gray-400 uppercase tracking-wide mb-0.5">Based In</p>
            <p className="font-semibold text-gray-800">Alpharetta, GA — serving clients nationwide</p>
          </div>
        </div>
...
export default function HeroSection() {
  ...
  return (
    ...
    {modalOpen && <EmployerModal onClose={() => setModalOpen(false)} />}
    </>
  )
}
